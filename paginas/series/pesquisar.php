                    ...
                    <?php
                        if(isset($_POST["pesquisar"])){
                            ...
                            if($txtPesquisa == '' || $filtro == ''){
                                ...
                                if($filtro == 'nome'){
                                    $mysqlPesq = 'SELECT * FROM series WHERE (id_usuario = '. $_SESSION['id'].') && ((nome LIKE "'.$txtPesquisa.'%") || (nome LIKE "%'.$txtPesquisa.'%") || (nome LIKE "%'.$txtPesquisa.'")) ;';
                                }else if($filtro == 'genero'){
                                    $mysqlPesq = 'SELECT * FROM series WHERE (id_usuario = '. $_SESSION['id'].') && ((genero LIKE "'.$txtPesquisa.'%") || (genero LIKE "%'.$txtPesquisa.'%") || (genero LIKE "%'.$txtPesquisa.'")) ;';
                                }else{
                                    $mysqlPesq = 'SELECT * FROM series WHERE (id_usuario = '. $_SESSION['id'].') && ((ano_lanc LIKE "'.$txtPesquisa.'%") || (ano_lanc LIKE "%'.$txtPesquisa.'%") || (ano_lanc LIKE "%'.$txtPesquisa.'")) ;';
                                }
